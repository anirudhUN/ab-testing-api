...
const corsOptions = {
  origin: ['http://localhost:3001', 'https://fragment2.vercel.app', 'https://ab-test-inky.vercel.app',`https://d3uaqhvuvl9zd8.cloudfront.net/html/index.html`,`https://d3uaqhvuvl9zd8.cloudfront.net/*`],
  methods: ['GET', 'POST'],
